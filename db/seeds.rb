...
tasks << Task.create(
    ...
    description: "Wash floor, walls and everithin",
    start: nil,
    end: nil,
    achieved: rand(0..100),
    priority: rand(0..100)
...
# Teams Tasks
teams[0].tasks << [tasks[0], tasks[2]]
teams[1].tasks <<  tasks[3]
teams[2].tasks << [tasks[1], tasks[4]]

# Teams Mutants
teams[0].mutants << mutants
teams[1].mutants << [mutants[0], mutants[2]]
teams[2].mutants << [mutants[0], mutants[1]]

# Mutants Tasks
mutants[0].tasks << tasks
mutants[1].tasks << [tasks[4], tasks[0]]
mutants[2].tasks << [tasks[0], tasks[2], tasks[3]]
